   ...
   <h3>Your Orders</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" name="flat" placeholder="e.g. Barangay" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>City :</span>
            <input type="text" name="city" placeholder="Laoag" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Province:</span>
            <input type="text" name="state" placeholder="Ilocos Norte" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Country :</span>
